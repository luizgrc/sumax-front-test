...
@Component({
  selector: 'kt-menu-horizontal-sumax',
  templateUrl: './menu-horizontal-sumax.component.html',
  styleUrls: ['./menu-horizontal-sumax.component.scss']
})
export class MenuHorizontalSumaxComponent implements OnInit, AfterViewInit {
