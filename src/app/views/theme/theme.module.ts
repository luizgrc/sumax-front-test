...
import { SubheaderSumaxComponent } from './subheader-sumax/subheader-sumax.component';
import { MenuHorizontalSumaxComponent } from './menu-horizontal-sumax/menu-horizontal-sumax.component';
...
@NgModule({
	declarations: [
		...
		SubheaderSumaxComponent,

		MenuHorizontalSumaxComponent,
