...
@Component({
  selector: 'kt-gestion-transporte',
  templateUrl: './gestion-transporte.component.html',
  styleUrls: ['./gestion-transporte.component.scss']
})
export class GestionTransporteComponent implements OnInit {
  private gridApi;
